    ...
    <DashboardLayout role="student" title="Dashboard">
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="glass-card rounded-xl p-5 hover:shadow-card-hover transition-all duration-300 relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5" />
            <div className="relative space-y-4">
              ...
              {/* CTA Button */}
              <Button variant="gradient" className="w-full text-body font-semibold py-6" asChild>
                <Link to="/assessment">
                  Start Assessment
              ...
              <div className="border-t border-border/50 pt-4 space-y-3">
                ...
                <div className="flex items-center gap-3 justify-center">
                  <div className="px-4 py-2 rounded-full bg-primary/10 text-primary text-body font-semibold flex items-center gap-2 hover:bg-primary/20 transition-colors">
                    <FileCheck className="h-5 w-5" />
                    Career Report
                  </div>
                  <div className="px-4 py-2 rounded-full bg-accent/10 text-accent text-body font-semibold flex items-center gap-2 hover:bg-accent/20 transition-colors">
