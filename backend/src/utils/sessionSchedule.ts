 ...
 * 
 * Rules:
 * - All sessions scheduled for TODAY unlock at 1:54 AM IST and become UPCOMING
...
export async function updateSessionScheduleStatus(sessionId: string): Promise<any[]> {
  try {
    ...
    for (const item of scheduleItems) {
      ...
      // Check if session is scheduled for today (at 1:54 AM IST, all today's sessions unlock)
...
/**
 * Unlock all sessions scheduled for today at 1:54 AM IST
 * This function should be called by the cron job at 1:54 AM IST
